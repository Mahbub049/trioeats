                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                                <div className="form-control">
                                    <label className="input flex items-center gap-1 mb-6">
                                        ...
                                        <input {...register("name", { required: true })} type="text" placeholder="Enter Your Name" className="input border-0 hover:border-0 focus:border-0 w-full" required />
                                ...
                                <div className="form-control">
                                    <label className="input flex items-center gap-1 mb-6">
                                        ...
                                        <input {...register("photoURL", { required: true })} type="text" placeholder="Enter Photo URL" className="input border-0 hover:border-0 focus:border-0 w-full" required />
                                ...
                                <div className="form-control">
                                    <label className="input flex items-center gap-1 mb-6">
                                        ...
                                        <input {...register("email", { required: true })} type="email" placeholder="Enter Email Address" className="input border-0 w-full hover:border-0 focus:border-0" required />
