...
const Update = () => {
    ...
    const {_id, name, email, foodname, origin, category, image, price, quantity, description} = food;
        ...
        <div>
            <div className='container mx-auto'>
                ...
                <div className="bg-[linear-gradient(45deg,rgba(19,19,24,0.50),rgba(19,19,24,0.50)),url('/src/assets/bg-add-food.png')] bg-center bg-cover py-20 text-center my-6 rounded-xl mx-3 lg:mx-0">
                    <p className="lg:text-4xl text-2xl font-bold text-[#FFC3A1] mons">Update Food Item</p>
                </div>
                <div className="mt-8">
                    <form onSubmit={handleSubmit(onSubmit)} className="poppins mx-3 lg:mx-0">
                        <div className="flex flex-col md:flex-row lg:flex-row gap-2 lg:gap-4 mb-3">
                            ...
                            <div className="flex-1">
                                ...
                                <label className="input input-bordered border-[#A75D5D] flex items-center gap-2">
                                    ...
                                    <input {...register("email", { required: true })} type="email" defaultValue={email} className="grow" placeholder="User Email" />
                        ...
                        <div className="flex flex-col md:flex-row lg:flex-row gap-2 lg:gap-4 mb-3">
                            ...
                            <div className="flex-1">
                                ...
                                <label className="input input-bordered border-[#A75D5D] flex items-center gap-2">
                                    ...
                                    <input {...register("origin", { required: true })} type="text" className="grow" defaultValue={origin} placeholder="Food Origin" />
                        ...
                        <div className="flex flex-col md:flex-row lg:flex-row gap-2 lg:gap-4 mb-3">
                            ...
                            <label className="input input-bordered border-[#A75D5D] flex items-center gap-2">
                                ...
                                <input {...register("category", { required: true })} type="text" className="grow" defaultValue={category} placeholder="Food Category" />
                        ...
                        <div className="flex-1">
                            ...
                            <label className="input input-bordered border-[#A75D5D] flex items-center gap-2">
                                ...
                                <input {...register("image", { required: true })} type="text" className="grow" defaultValue={image} placeholder="Image URL" />
                        ...
                        <div className="mb-8">
                            ...
                            <label className="input input-bordered border-[#A75D5D] flex items-center gap-2">
                                ...
                                <input {...register("description", { required: true })} type="text" className="grow" defaultValue={description} placeholder="Short Description" />
                                {errors.description && <span className="text-red-500">This field is required</span>}
                            </label>
                        </div>
                        <button className="btn btn-wide w-full text-white font-semibold text-xl bg-[#A75D5D]">Update</button>
                    </form>
                </div>
            </div>
            <Footer></Footer>
