                        ...
                        <div className="hero-content flex-col lg:flex-row gap-6">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                                ...
                                <label className="input flex items-center gap-1 mb-6">
                                    ...
                                    <input {...register("email", { required: true })} type="email" placeholder="Enter Email Address" className="input w-full border-0 hover:border-0 focus:border-0" required />
                                ...
                                <label className="input flex items-center gap-1 mb-6">
                                    ...
                                    <input {...register("password", { required: true })} type="password" placeholder="Password" className="input border-0 w-full hover:border-0 focus:border-0" required />
                                    {errors.email && <span>This field is required</span>}
                                </label>
                                </div>
